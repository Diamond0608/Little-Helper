...
A while back after a robotics competition called the National Robotics League, a teacher saw our robot moving blocks around and jokingly asked, could you make it move the textbooks from class to class? We laughed it off, but when I was preparing an idea for Fallout - a Hack Club program, I thought why not actually do that? I love building bots that can drive and it would actually be usefull. (Note this project was submitted to Hack Club's Beest Program, not fallout).
