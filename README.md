...
The cost of building it is completely and elaborately detailed in the BOM ( Bill of Materials ) showcased in this repo, but the average cost would be around INR 19417 all inclusive, however bear in mind that if you can make the chassis yourself it would be significantly cheaper as all the components except for teh chassis comes to INR 9417.
